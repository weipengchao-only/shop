<template>
	<div>
			...
			<el-table :data="userList" style="width: 100%" stripe>
				  ...
				  <el-table-column label="操作" width="180">
					  <template slot-scope="scope">
						  ...
						  <!--分享按钮-->
						  <el-tooltip  effect="dark" content="分配角色" placement="top" :enterable="false"><!--:enterable="false"鼠标移入时提示文字自动隐藏-->
		...
		<el-dialog
		  ...
		  <!--内容主体区-->
		 <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="70px"><!--model是数据绑定对象，rules是验证规则对象-->
		   <el-form-item label="用户名" prop="username"><!--prop跟的是验证的属性名-->
		     <el-input v-model="ruleForm.username"></el-input>
		   </el-form-item>
		   <el-form-item label="邮箱" prop="email"><!--prop跟的是验证的属性名-->
		     <el-input v-model="ruleForm.email"></el-input>
		   </el-form-item>
		   <el-form-item label="手机号" prop="mobile"><!--prop跟的是验证的属性名-->
		     <el-input v-model="ruleForm.mobile"></el-input>
		   </el-form-item>
		   <el-form-item label="密码" prop="password"><!--prop跟的是验证的属性名-->
		...
		<el-dialog
		  ...
		  <el-form ref="editFormRef" :model="editForm" label-width="80px" :rules="rules">
		    <el-form-item label="用户名">
		      <el-input v-model="editForm.username" disabled></el-input><!--disabled 是对话框禁用-->
		    </el-form-item>
			<el-form-item label="邮箱" prop="email">
			  <el-input v-model="editForm.email" ></el-input><!--disabled 是对话框禁用-->
			</el-form-item>
			<el-form-item label="手机号" prop="mobile">
			  <el-input v-model="editForm.mobile" ></el-input><!--disabled 是对话框禁用-->
			</el-form-item>
		  </el-form>
		  <span slot="footer" class="dialog-footer">
